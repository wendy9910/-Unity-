...
public class meshmodel3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (down == 1)
        {
            ...
            if (dist > 1.0f)
            {
                WidthGenerate(MousePos, LastPos);
                MousePos = Camera.main.ScreenToWorldPoint(new Vector3(Input.mousePosition.x, Input.mousePosition.y, 10.0f));
                LastPos = Camera.main.ScreenToWorldPoint(new Vector3(Input.mousePosition.x, Input.mousePosition.y, 10.0f));
            }
        }
    ...
    void MeshGenerate()
    {
        ...
        point = ((MousePointPos.Count / (3 + (width-1)*2 ) - 1)) * 2 * width;
    ...
    void WidthGenerate(Vector3 pos1, Vector3 pos2)
    {
    ...
    void WidthAdd1(Vector3 Vec, Vector3 pos)
    {
