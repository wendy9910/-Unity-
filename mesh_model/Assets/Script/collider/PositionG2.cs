...
public class PositionG2 : MonoBehaviour
{

    public Vector3[] thickness1;//計算寬度增加座標
    public Vector3[] thickness2;
    public static List<Vector3> GetPoint = drawer_col.PointPos;

    public static List<Vector3> tempPoint = new List<Vector3>();//變形時暫存用
    public List<Vector3> GetUpdatePoint = drawer_col.UpdatePoint;
    public List<Vector3> GetLenPoint = drawer_col.LenPoint;
